...
/**
 * Legacy Streamlit component that contains all the original logic
 */
export const StreamlitLegacy: React.FC = () => {
  React.useEffect(() => {
...
// Export the mount function for backward compatibility
export { mount as mountLegacy };
